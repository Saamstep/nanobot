      ...
      if (stats.online) {
        ...
        const embed = {
          ...
          author: {
            name: args[0],
            url: 'https://mcsrvstat.us/',
            icon_url: 'https://gamepedia.cursecdn.com/minecraft_gamepedia/4/44/Grass_Block_Revision_6.png'
          },
          fields: [
            {
              name: 'Online',
        ...
        client.error(
          "I'm having trouble finding that server, please make sure you typed the IP in correctly!",
          message
        );
      }
    } catch (e) {
